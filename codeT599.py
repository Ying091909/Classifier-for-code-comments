...
def main():
    ...
    parser.add_argument("--train_log_filename", default="train.log", type=str, help="The train log file for this task.")
    ## Other parameters /home/liying/CODE/codet5/dataset
    parser.add_argument("--train_filename", default="dataset/java/train_data_of_deprecation.jsonl", type=str,
                        help="The train filename. Should contain the .jsonl files for this task.")
    parser.add_argument("--dev_filename", default="dataset/java/val_data_of_deprecation.jsonl", type=str,
                        help="The dev filename. Should contain the .jsonl files for this task.")
    parser.add_argument("--test_filename", default="dataset/java/test_data_of_deprecation.jsonl", type=str,
    ...
    if args.load_model_path is not None:
        ...
        model.load_state_dict(torch.load(args.load_model_path, map_location=torch.device('cpu'))) ## modified
